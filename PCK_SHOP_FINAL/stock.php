...
<html lang="en">
  ...
  <head>
    ...
    <style>
        ...
        footer {
            margin-top: 200px; /* เพิ่มระยะห่างด้านบนของ footer */
        }
...
ชื่อสินค้า:<input type="text" name="name_food"><br>
ราคา: <input type="number" name="price"><br>
แคลอรี่<input type="text" name="calorie"><br>
<select name="typ_id">
        <option value="T001">อาหาร</option>
        <option value="T002">ขนม</option>
        <option value="T003">เครื่องดื่ม</option>
    </select><br>
<input type="submit" value="เพิ่มสนค้า ">
</article>
